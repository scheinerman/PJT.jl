...
\begin{proof}
  ...
  \item $v=(0,\barv,0)$ and $w=(0,\barw,1)$: Cannot happen because 
    $\rhov=(0,\rhobarv,0) \not\prec (1,\rhobarw,0) = \rhow$.


  \item $v=(0,\barv,0)$ and $w=(1,\barw,0)$:


  \item $v=(0,\barv,0)$ and $w=(1,\barw,1)$:

    \newthought
    
  \item $v=(0,\barv,1)$ and $w=(0,\barw,0)$:


  \item $v=(0,\barv,1)$ and $w=(0,\barw,1)$:


  \item $v=(0,\barv,1)$ and $w=(1,\barw,0)$:


  \item $v=(0,\barv,1)$ and $w=(1,\barw,1)$:

    
    \newthought

  \item $v=(1,\barv,0)$ and $w=(0,\barw,0)$: 

  \item $v=(1,\barv,0)$ and $w=(0,\barw,1)$: 

  \item $v=(1,\barv,0)$ and $w=(1,\barw,0)$:

  \item $v=(1,\barv,0)$ and $w=(1,\barw,1)$:

    \newthought
    
  \item $v=(1,\barv,1)$ and $w=(0,\barw,0)$:


  \item $v=(1,\barv,1)$ and $w=(0,\barw,1)$:


  \item $v=(1,\barv,1)$ and $w=(1,\barw,0)$:


  \item $v=(1,\barv,1)$ and $w=(1,\barw,1)$:
  ...
  %   $v=(s,\barv,t)$ and $w=(s,\barw,t)$ where
  %   $s,t\in\{0,1\}$. [This covers 4 cases.]


  %   It follows that $x\prec y$ in $W_{b-2}$ and therefore there is a
  %   sequence of H/I transformations that convert $\barv$ to $\barw$
  %   (by induction). The same sequence converts $v$ to $w$.

    
  % \item Case II: Suppose $v=(1,\barv,0)$ and $w=(0,\barw,t)$ with
  %   $t\in\{0,1\}$. [2~cases] 

  %   This cannot occur because it violates $v \prec w$. 

 
  % \item Case III: Suppose $v=(s,\barv,1)$ and $w=(1,\barw,0)$ with
  %   $s\in\{0,1\}$. [2~cases]

  %   This cannot occur because $\rho v = (1,\rho\barv,s)$ and
  %   $w=(0,\rho\barw,1)$, violating $v \prec w$. 




  % \item Case ZZ: Suppose that $v=(0x1)$ and $w=(1y0)$. Suppose, for
